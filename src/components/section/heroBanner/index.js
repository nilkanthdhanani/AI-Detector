                    ...
                    <div className={styles.aiBoxInner}>
                        <div className={` ${styles.aiBoxInnerDiv} ${styles.aiBoxInnerDiv1}`}>
                            <div className={styles.aiBoxInnerDivText}>
                                <textarea placeholder='To rewrite or check your content, type or paste it here and click on the button below' rows={12} aria-label='text box'></textarea>
                            </div>
                        ...
                        <div className={styles.aiBoxInnerDiv}>
                            <div className={styles.aiBoxInnerDivText}>
                                <textarea rows={12} aria-label='text box'></textarea>
                            </div>
